...
class ImageMigrator:
    ...
    def __init__(self, bootc_manager: BootcManager, 
    ...
    def find_migration(self, current_image: str) -> Optional[Dict[str, Any]]:
        ...
        logger.debug(f"Checking {len(migrations)} migrations for image: {current_image}")
    ...
    def _is_migration_applicable(self, migration: Dict[str, Any], 
                               current_image: str) -> bool:
        ...
        if effective_date:
            try:
                ...
                if datetime.now() < effective_dt:
                    logger.debug(f"Migration not yet effective (effective: {effective_date})")
                    return False
    ...
    def _log_migration(self, migration: Dict[str, Any], 
                      from_image: str, to_image: str) -> None:
    ...
    def get_pending_migrations(self, current_image: str, 
